...
lat, long = wind[wind['wind_plant']=='Unit1'].loc[0, ['latitude', 'longitude']]
wind = wind[wind['wind_plant']=='Unit1'].loc[:168]
wind.loc[:, ['temp',  'pressure',  'wind_speed (m/s)',  'wind_dir']] = get_weather_forecast(lat, long)
...
st.title('Energy production for wind NR1')
